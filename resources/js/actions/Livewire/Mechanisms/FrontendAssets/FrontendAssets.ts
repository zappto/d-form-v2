...
* @route '/livewire-1954bb72/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1954bb72/livewire.js',
...
* @route '/livewire-1954bb72/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-1954bb72/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-1954bb72/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-1954bb72/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
