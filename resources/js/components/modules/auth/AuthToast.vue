...
<template>
    <Transition name="toast">
        <div
            v-if="toast"
            class="fixed right-4 top-4 z-50 flex items-center gap-3 rounded-2xl border-2 border-[#101014] px-5 py-3.5 font-bold shadow-[6px_6px_0_#101014]"
            :class="toast.type === 'success' ? 'bg-[#41F0B4] text-[#101014]' : 'bg-[#FF6B6B] text-[#101014]'"
        >
            ...
            <span class="text-sm font-extrabold">{{ toast.message }}</span>
