...
<template>
    <div>
        ...
        <div class="grid grid-cols-2 gap-3">
            <Link :href="redirectToGoogle()">
                <Button variant="outline" class="w-full cursor-pointer transition-all active:scale-[.98]">
            ...
            <Link :href="redirectToGithub()">
                <Button variant="outline" class="w-full cursor-pointer transition-all active:scale-[.98]">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="#111827">
                        <path
